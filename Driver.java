...
public class Driver {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("number of swaps required: " + Sorts.bubbleSortV(test1));
    System.out.println("--");
    System.out.println("Random case scenario: ");
    ArrayList test2 = Sorts.populate(5, 1, 10);
    System.out.println("test2 unsorted: " + test2);
    System.out.println("number of swaps required: " + Sorts.bubbleSortV(test2));
    System.out.println("--");
    ...
    System.out.println("number of swaps required: " + Sorts.bubbleSortV(test3));

    System.out.println("------------------------------------------------------------------------");

    System.out.println("Testing selectionSortV...");
    ...
    System.out.println("number of swaps required: " + Sorts.selectionSortV(test4));
    System.out.println("--");
    System.out.println("Random case scenario: ");
    ArrayList test5 = Sorts.populate(5, 1, 10);
    System.out.println("test5 unsorted: " + test5);
    System.out.println("number of swaps required: " + Sorts.selectionSortV(test5));
    System.out.println("--");
    ...
    System.out.println("number of swaps required: " + Sorts.selectionSortV(test6));
    ...
    System.out.println("number of swaps required: " + Sorts.insertionSortV(test7));
    System.out.println("--");
    System.out.println("Random case scenario: ");
    ArrayList test8 = Sorts.populate(5, 1, 10);
    System.out.println("test8 unsorted: " + test8);
    System.out.println("number of swaps required: " + Sorts.insertionSortV(test8));
    System.out.println("--");
    System.out.println("Worst case scenario: The array is in descending order");
    ...
    System.out.println("number of swaps required: " + Sorts.insertionSortV(test9));
  }
